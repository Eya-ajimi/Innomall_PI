...
public class EmailService {
    ...
    public static void sendPasswordResetEmail(String recipientEmail, int resetToken) {
        final String username = "Innomall.esprit@gmail.com"; // Remplacez par votre e-mail Gmail
        final String password = "wlbk qhlt gack trkr"; // Remplacez par votre mot de passe d'application
